...
/* harmony import */ var _raw_loader_edit_profile_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./edit-profile.page.html */ "iVtL");
/* harmony import */ var _edit_profile_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit-profile.page.scss */ "uGZ0");
...
/* harmony import */ var _authentication_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../authentication.service */ "UxNV");
...
let EditProfilePage = class EditProfilePage {
    constructor(alertController, user, router, authService, afDatabase, alertCtrl, platform, sanitizer) {
    ...
    ngOnInit() {
        ...
        this.authService.getUserData().snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(changes => changes.map(c => (Object.assign({ user_id: c.payload.key }, c.payload.val()))))).subscribe(() => {
            this.userId = firebase__WEBPACK_IMPORTED_MODULE_6__["default"].auth().currentUser.uid;
    ...
    getPicture(type) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const image = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_11__["Camera"].getPhoto({
                quality: 100,
                width: 400,
                allowEditing: false,
    ...
    updateDetails(name, username) {
        firebase__WEBPACK_IMPORTED_MODULE_6__["default"].auth().onAuthStateChanged((user) => {
            if (user) {
                // User logged in already or has just logged in.
                this.user_id = user.uid;
                if (!this.getPhoto) {
                    firebase__WEBPACK_IMPORTED_MODULE_6__["default"].database().ref('users/' + this.user_id).update({
                        names: name.value,
...
/* harmony import */ var _edit_profile_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit-profile.page */ "1reJ");
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "TEn/");
/* harmony import */ var _edit_profile_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edit-profile-routing.module */ "eBKE");
/* harmony import */ var _edit_profile_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edit-profile.page */ "1reJ");
