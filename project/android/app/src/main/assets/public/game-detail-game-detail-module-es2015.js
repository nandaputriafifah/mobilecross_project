...
/* harmony import */ var _raw_loader_game_detail_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./game-detail.page.html */ "uXb1");
/* harmony import */ var _game_detail_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./game-detail.page.scss */ "yGL/");
...
let GameDetailPage = class GameDetailPage {
    constructor(gameService, router, afDatabase, loadingCtrl, alertCtrl, route) {
    ...
    ngOnInit() {
        this.gameService.getAllQuizes().snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(changes => changes.map(c => (Object.assign({ quiz_id: c.payload.key }, c.payload.val()))))).subscribe(data => {
            this.quizes = data;
            firebase__WEBPACK_IMPORTED_MODULE_8__["default"].database().ref('/quiz').on('value', () => { });
            firebase__WEBPACK_IMPORTED_MODULE_8__["default"].database().ref('/quiz').once('value', () => { });
        });
        this.gameService.getUserData().snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(changes => changes.map(c => (Object.assign({ user_id: c.payload.key }, c.payload.val()))))).subscribe(() => {
            this.userId = firebase__WEBPACK_IMPORTED_MODULE_8__["default"].auth().currentUser.uid;
    ...
    postScoreToFirebase() {
        firebase__WEBPACK_IMPORTED_MODULE_8__["default"].auth().onAuthStateChanged((user) => {
            if (user) {
                // User logged in already or has just logged in.
                this.user_id = user.uid;
                console.log('===USER ID===', this.user_id);
                // This for post quiz history to field quiz_history in firebase
                firebase__WEBPACK_IMPORTED_MODULE_8__["default"].database().ref('users/' + this.user_id + '/quiz_history').push({
                ...
                firebase__WEBPACK_IMPORTED_MODULE_8__["default"].database().ref('users/' + this.user_id + '/points').set({
                    user_score: this.score,
                    user_point: this.score / 10
                });
                // This for update total_points for user
                firebase__WEBPACK_IMPORTED_MODULE_8__["default"].database().ref('users/' + this.user_id).update({
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const alert = yield this.alertCtrl.create({
                ...
                buttons: [
                    {
                        text: 'YA',
                        handler: () => this.presentLoading().then(() => {
...
GameDetailPage.propDecorators = {
    slide: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['quizSlider',] }],
...
/* harmony import */ var _game_detail_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./game-detail.page */ "BIhc");
...
/* harmony import */ var _game_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./game-detail-routing.module */ "M5IV");
/* harmony import */ var _game_detail_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./game-detail.page */ "BIhc");
