(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    /***/
    function g5m(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JNZR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function hd7r(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(authService, router, loadingCtrl) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function logIn(email, password) {
            ...
            this.authService.SignIn(email.value, password.value).then(function (res) {
              if (_this.authService.isEmailVerified) {
                _this.router.navigate(['home/tabs/landing-page']);
              } else {
          ...
          key: "presentLoading",
          value: function presentLoading(email, password) {
    ...
    /***/
    function mmPB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
