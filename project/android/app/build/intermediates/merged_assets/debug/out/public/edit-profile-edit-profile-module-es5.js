(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["edit-profile-edit-profile-module"], {
    ...
    "1reJ":
    /*!********************************************************!*\
      !*** ./src/app/home/edit-profile/edit-profile.page.ts ***!
      \********************************************************/

    /*! exports provided: EditProfilePage */

    /***/
    function reJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var EditProfilePage = /*#__PURE__*/function () {
        function EditProfilePage(alertController, user, router, authService, afDatabase, alertCtrl, platform, sanitizer) {
        ...
        _createClass(EditProfilePage, [{
          ...
          value: function ngOnInit() {
            ...
            this.authService.getUserData().snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (changes) {
              ...
              _this2.userId = firebase__WEBPACK_IMPORTED_MODULE_6__["default"].auth().currentUser.uid;
              console.log('USER ID CURRENT', _this2.userId);

              _this2.afDatabase.database.ref('users/' + _this2.userId).once('value').then(function (userDetailsAsObject) {
                _this2.names = userDetailsAsObject.val().names;
                _this2.usernames = userDetailsAsObject.val().usernames;
                _this2.profilePicture = userDetailsAsObject.val().photo_profile;
              })["catch"](function (err) {
                      ...
                      return this.alertCtrl.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            return _this3.getPicture('camera');
                          }
                        }]
                      });
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      if (!(!_capacitor_core__WEBPACK_IMPORTED_MODULE_11__["Capacitor"].isPluginAvailable('Camera') || this.isDesktop && type === 'gallery')) {
                        _context2.next = 3;
                        break;
                      }
                    ...
                    case 3:
                      _context2.next = 5;
                      return _capacitor_core__WEBPACK_IMPORTED_MODULE_11__["Camera"].getPhoto({
                        quality: 100,
                        width: 400,
                        allowEditing: false,
                        resultType: _capacitor_core__WEBPACK_IMPORTED_MODULE_11__["CameraResultType"].DataUrl,
                        source: _capacitor_core__WEBPACK_IMPORTED_MODULE_11__["CameraSource"].Prompt
                      });
          ...
          value: function onFileChoose(event) {
            ...
            reader.onload = function () {
              _this4.photo = reader.result.toString();
            };
          ...
          key: "updateDetails",
          value: function updateDetails(name, username) {
            var _this5 = this;

            firebase__WEBPACK_IMPORTED_MODULE_6__["default"].auth().onAuthStateChanged(function (user) {
              if (user) {
                // User logged in already or has just logged in.
                _this5.user_id = user.uid;

                if (!_this5.getPhoto) {
                  firebase__WEBPACK_IMPORTED_MODULE_6__["default"].database().ref('users/' + _this5.user_id).update({
                    names: name.value,
                    usernames: username.value
                  });
                } else if (_this5.getPhoto) {
                  firebase__WEBPACK_IMPORTED_MODULE_6__["default"].database().ref('users/' + _this5.user_id).update({
                    photo_profile: _this5.getPhoto,
                    names: name.value,
                    usernames: username.value
                  });
                }

                _this5.router.navigateByUrl('/home/tabs/profile');
    ...
    "eBKE":
    /*!******************************************************************!*\
      !*** ./src/app/home/edit-profile/edit-profile-routing.module.ts ***!
      \******************************************************************/

    /*! exports provided: EditProfilePageRoutingModule */

    /***/
    function eBKE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "iVtL":
    /*!************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/home/edit-profile/edit-profile.page.html ***!
      \************************************************************************************************/

    /*! exports provided: default */

    /***/
    function iVtL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ion-header>\r\n  <ion-toolbar>\r\n      <ion-buttons slot=\"start\">\r\n          <ion-back-button></ion-back-button>\r\n      </ion-buttons>\r\n    <ion-title>Edit Profile</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content>\r\n    <app-loading *ngIf=\"busy\"></app-loading>\r\n    <div>\r\n        <ion-img *ngIf=\"!photo\" (click)=\"presentAlert()\" src=\"{{profilePicture}}\"></ion-img>\r\n        <ion-card *ngIf=\"photo\" (click)=\"presentAlert()\">\r\n            <ion-card-content>\r\n                <img [src]=\"photo\">\r\n            </ion-card-content>\r\n        </ion-card>\r\n    </div>\r\n\r\n\r\n    <div class=\"profile-info\">\r\n        <ion-item>\r\n            <ion-label position=\"floating\">Name</ion-label>\r\n            <ion-input ngModel=\"{{names}}\" #name></ion-input>\r\n        </ion-item>\r\n\r\n        <ion-item>\r\n            <ion-label position=\"floating\">Username</ion-label>\r\n            <ion-input ngModel=\"{{usernames}}\" #username></ion-input>\r\n        </ion-item>\r\n\r\n        <input type=\"file\" *ngIf=\"isDesktop\" #filePicker (change)=\"onFileChoose($event)\"/>\r\n\r\n        <ion-button fill=\"solid\" expand=\"block\" color=\"secondary\" (click)=\"updateDetails(name, username)\">Simpan</ion-button>\r\n\r\n    </div>\r\n</ion-content>\r\n";
      /***/
    },
    ...
    "uGZ0":
    /*!**********************************************************!*\
      !*** ./src/app/home/edit-profile/edit-profile.page.scss ***!
      \**********************************************************/

    /*! exports provided: default */

    /***/
    function uGZ0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = ".filebtn {\n  opacity: 0;\n  position: absolute;\n  top: -100cm;\n  left: -100cm;\n}\n\ninput[type=file] {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    "yJ8b":
    /*!**********************************************************!*\
      !*** ./src/app/home/edit-profile/edit-profile.module.ts ***!
      \**********************************************************/

    /*! exports provided: EditProfilePageModule */

    /***/
    function yJ8b(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      EditProfilePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _edit_profile_routing_module__WEBPACK_IMPORTED_MODULE_5__["EditProfilePageRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forChild(routes)],
