(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["results-results-module"], {
    ...
    /***/
    function IvqK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function P7BW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function VIp7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function cm9o(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function d0RV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_results_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./results.page.html */
      "IvqK");
      /* harmony import */


      var _results_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./results.page.scss */
      "P7BW");
      /* harmony import */
      ...
      var ResultsPage = /*#__PURE__*/function () {
        function ResultsPage(gameService, afDatabase, router) {
          ...
          value: function ngOnInit() {
            ...
            this.gameService.getUserData().snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (changes) {
              ...
              _this.afDatabase.database.ref('users/' + _this.userId).once('value').then(function (userDetailsAsObject) {
                _this.userPoints = userDetailsAsObject.val().points.user_point;
                _this.userScores = userDetailsAsObject.val().points.user_score;
              })["catch"](function (err) {
      ...
      ResultsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
