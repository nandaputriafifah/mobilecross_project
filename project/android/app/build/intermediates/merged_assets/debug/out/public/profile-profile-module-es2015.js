...
let ProfilePage = class ProfilePage {
    constructor(authService, afDatabase) {
        this.authService = authService;
        this.afDatabase = afDatabase;
    }
    ngOnInit() {
        this.authService.getUserData().snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(changes => changes.map(c => (Object.assign({ user_id: c.payload.key }, c.payload.val()))))).subscribe(() => {
